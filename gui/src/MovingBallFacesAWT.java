...
public class MovingBallFacesAWT {
    ...
    class FaceObj {
        ...
        public void makeEyes(Graphics g, int eyeSize) {
            ...
            g.fillOval(xStart + (h * 2 / 7) + emo * 2, yStart + (w * 1 / 3),
                    eyeSize, eyeSize);
            g.fillOval(xStart + (h * 4 / 7) + emo * 2, yStart + (w * 1 / 3),
                    eyeSize, eyeSize);
        }
        ...
        public void makeMouth(Graphics g, int mouseSize) {
            ...
            g.drawLine(xMiddle - mouseSize / 2, yMiddle + emo * 2, xMiddle + mouseSize
                    / 2, yMiddle);
        }
